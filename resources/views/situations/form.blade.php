...
<div class="bg-indigo-400 p-4 bg-opacity-5">
    <div class="max-w-sm mx-auto md:w-full md:mx-0">
        <div class="inline-flex items-center space-x-4">
            <h1 class="text-gray-800 font-bold">Open a Situation</h1>
        </div>
    </div>
</div>
...
<div class="bg-white space-y-6 border-b border-gray-200 pt-2 pb-6">
    <div class="inline-flex space-y-4 space-y-0 w-full p-4 text-gray-700 items-center">
        <h2 class="md:w-1/4 max-w-sm mx-auto">Title *</h2>
...
<div class="bg-white space-y-6 border-b border-gray-200 pt-2 pb-6">
    <div class="inline-flex space-y-4 space-y-0 w-full p-4 text-gray-700 items-center">
        <h2 class="md:w-1/4 max-w-sm mx-auto">Type *</h2>
        <div class="md:w-3/4 max-w-3xl">
            <div class="w-full inline-flex border">
...
<div class="bg-white space-y-6 border-b border-gray-200 pt-2 pb-6">
    <div class="inline-flex space-y-4 space-y-0 w-full p-4 text-gray-700 items-center">
        <h2 class="md:w-1/4 max-w-sm mx-auto">Description</h2>
        <div class="md:w-3/4 max-w-3xl">
            <div class="w-full inline-flex border">
                <textarea
                    rows="5"
...
<div class="bg-white space-y-6 border-b border-gray-200 pt-2 pb-6">
    <div class="inline-flex space-y-4 space-y-0 w-full p-4 text-gray-700 items-center">
        ...
        <div class="md:w-3/4 max-w-3xl">
            <div class="w-full">
                <button type="submit" class="text-white mx-auto max-w-sm rounded-md text-center bg-indigo-400 py-2 px-4 focus:outline-none">
                    Submit
                </button>
            </div>
        </div>
